...
## Medição corrente — depois da vigésima revisão

| | |
|---|---|
| **Commit** | `8162120` — a árvore da solução .NET que foi medida |
...
última antes do commit `8162120`, que contém **exatamente** a árvore medida —
