...
## Medição corrente — depois do autômato testado

| | |
|---|---|
| **Commit** | `1dfd782` — a árvore da solução .NET que foi medida |
...
última antes do commit `1dfd782`, que contém **exatamente** a árvore medida —
