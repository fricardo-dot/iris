...
## Medição corrente — depois da vigésima terceira revisão

| | |
|---|---|
| **Commit** | `4592cfc` — a árvore da solução .NET que foi medida |
...
última antes do commit `4592cfc`, que contém **exatamente** a árvore medida —
