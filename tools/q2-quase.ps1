...
Write-Host ""
Write-Host "Ou seja: ENTRE OS ITENS QUE ESTE ROTEIRO LEU nas quatro pastas padrao"
Write-Host "nao ha par que devesse ser correlacionado -- e o corpus e o que o"
Write-Host "Levantar conseguiu ler, nao a caixa."
